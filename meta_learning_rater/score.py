...
python -m meta_learning_rater.score \
    ...
    --annotation datasets/electricity/annotation.jsonl  # optional, for few-shot adapt
"""
...
def main() -> None:
    ...
    parser.add_argument("--blocks",      required=True, help="blocks.jsonl path")
    parser.add_argument("--model",       required=True, help="ScoreModel .pth checkpoint")
    parser.add_argument("--output",      required=True, help="Output scores.jsonl path")
    parser.add_argument("--annotation",  default=None,  help="annotation.jsonl for few-shot adapt")
